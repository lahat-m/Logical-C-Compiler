...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_binary_expr = 23,               /* binary_expr  */
  YYSYMBOL_binary_op = 24,                 /* binary_op  */
  YYSYMBOL_unary_expr = 25,                /* unary_expr  */
  YYSYMBOL_quant_expr = 26,                /* quant_expr  */
  YYSYMBOL_quantifier = 27,                /* quantifier  */
  YYSYMBOL_domain = 28,                    /* domain  */
  YYSYMBOL_domain_list = 29,               /* domain_list  */
  YYSYMBOL_atom_expr = 30,                 /* atom_expr  */
  YYSYMBOL_predicate = 31,                 /* predicate  */
  YYSYMBOL_arg_list = 32,                  /* arg_list  */
  YYSYMBOL_variable = 33,                  /* variable  */
  YYSYMBOL_literal = 34                    /* literal  */
};
...
{
       0,    64,    64,    72,    76,    80,    84,    91,    98,    99,
     100,   101,   102,   106,   113,   120,   121,   125,   132,   137,
     142,   147,   155,   159,   163,   167,   174,   188,   192,   206,
     213,   217
};
#endif
...
static const char *const yytname[] =
{
  ...
  "','", "$accept", "program", "expr", "binary_expr", "binary_op",
  "unary_expr", "quant_expr", "quantifier", "domain", "domain_list",
  "atom_expr", "predicate", "arg_list", "variable", "literal", YY_NULLPTR
};
...
{
      -3,    -3,   -33,   -33,   -33,   -33,    -3,   -33,   -12,    13,
      29,   -33,   -33,   -33,     2,   -33,   -33,   -33,   -33,    29,
      14,     6,   -33,   -33,   -33,   -33,   -33,   -33,    -3,     1,
     -33,     5,    11,    29,   -14,    -3,     6,   -33,     7,    10,
      15,    29,   -33,   -14,   -14,   -33,   -33,   -33
};
...
{
       0,     0,    15,    16,    30,    31,     0,    29,     0,     0,
       2,     3,     4,     5,     0,     6,    23,    24,    25,    13,
       0,     0,     1,     8,     9,    10,    11,    12,     0,     0,
      22,    27,     0,     7,     0,     0,     0,    26,    18,    19,
       0,    14,    28,     0,     0,    17,    20,    21
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -33,   -33,    -1,   -33,   -33,   -33,   -33,   -33,   -33,   -32,
     -33,   -33,    -6,   -33,   -33
};
...
{
      19,    21,     1,    38,    39,    20,     2,     3,     4,     5,
       6,    46,    47,    22,     7,     8,    34,    23,    24,    29,
      25,    26,    27,    31,    36,    37,    43,    33,    30,    44,
      42,    45,    23,    24,    41,    25,    26,    27
};

static const yytype_int8 yycheck[] =
{
       1,    13,     5,    17,    18,     6,     9,    10,    11,    12,
      13,    43,    44,     0,    17,    18,    15,     3,     4,    17,
       6,     7,     8,    17,    19,    14,    19,    28,    14,    19,
      36,    16,     3,     4,    35,     6,     7,     8
};
...
static const yytype_int8 yystos[] =
{
      ...
      22,    23,    25,    26,    27,    30,    31,    33,    34,    22,
      22,    13,     0,     3,     4,     6,     7,     8,    24,    17,
      14,    17,    32,    22,    15,    28,    19,    14,    17,    18,
      29,    22,    32,    19,    19,    16,    29,    29
};
...
#line 1170 "parser.c"
  ...
  case 7: /* binary_expr: expr binary_op expr  */
#line 92 "parser.y"
        {
...
#line 1190 "parser.c"
  ...
  case 10: /* binary_op: IMPLIES  */
#line 100 "parser.y"
               { (yyval.token) = IMPLIES; }
#line 1196 "parser.c"
    break;

  case 11: /* binary_op: IFF  */
#line 101 "parser.y"
               { (yyval.token) = IFF; }
#line 1202 "parser.c"
    break;

  case 12: /* binary_op: XOR  */
#line 102 "parser.y"
               { (yyval.token) = XOR; }
#line 1208 "parser.c"
    break;

  case 13: /* unary_expr: NOT expr  */
#line 107 "parser.y"
        {
...
#line 1216 "parser.c"
  ...
  case 14: /* quant_expr: quantifier VARIABLE domain expr  */
#line 114 "parser.y"
        {
...
#line 1224 "parser.c"
  ...
  case 15: /* quantifier: FORALL  */
#line 120 "parser.y"
               { (yyval.token) = FORALL; }
#line 1230 "parser.c"
    break;

  case 16: /* quantifier: EXISTS  */
#line 121 "parser.y"
               { (yyval.token) = EXISTS; }
#line 1236 "parser.c"
    break;

  case 17: /* domain: LBRACKET domain_list RBRACKET  */
#line 126 "parser.y"
        {
...
#line 1262 "parser.c"
  ...
  case 20: /* domain_list: VARIABLE ',' domain_list  */
#line 143 "parser.y"
        {
...
#line 1271 "parser.c"
  ...
  case 21: /* domain_list: PREDICATE ',' domain_list  */
#line 148 "parser.y"
        {
            (yyval.domain_info).list = append_to_domain_list((yyvsp[0].domain_info).list, (yyvsp[0].domain_info).size, (yyvsp[-2].string_val));
            (yyval.domain_info).size = (yyvsp[0].domain_info).size + 1;
...
#line 1280 "parser.c"
  ...
  case 22: /* atom_expr: LPAREN expr RPAREN  */
#line 156 "parser.y"
        {
...
#line 1312 "parser.c"
  ...
  case 26: /* predicate: PREDICATE LPAREN arg_list RPAREN  */
#line 175 "parser.y"
        {
...
#line 1335 "parser.c"
  ...
  case 28: /* arg_list: VARIABLE ',' arg_list  */
#line 193 "parser.y"
        {
